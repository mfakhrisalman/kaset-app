...
<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image: url({{ asset('assets_lp/images/img_bg_1.jpg') }});">
                ...
                <div class="col-md-4 text-center animate-box">
                    <div class="product">
                        <div class="product-grid" style="background-image:url({{ asset('storage/' . $produk->images) }});">
                            <div class="inner">
                                <form id="cart-form-{{ $produk->id }}" action="/product/cart" method="POST" style="display: none;">
                                    @csrf
                                ...
                                <p>
                                    ...
                                    @endcan
                                    <a href="/product-detail/{{ $produk->id }}" class="icon"><i class="icon-eye"></i></a>
                                </p>
                            </div>
                        </div>
                        <div class="desc">
                            <h3><a href="/product-detail/{{ $produk->id }}">{{ $produk->name }}</a></h3>
