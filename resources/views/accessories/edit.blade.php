...
<div class="flex items-center flex-wrap justify-between gap20 mb-27">
    ...
    <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
        ...
        <li>
            <div class="text-tiny">Edit Aksesoris</div>
        </li>
    </ul>
</div>

<form action="/accessories/{{ $produk->id }}" method="post" class="tf-section-1 form-add-product" enctype="multipart/form-data">
    @csrf
        ...
        <fieldset class="category">
            ...
            <div class="select">
                <select name="category" class="" required>
                    ...
                    <option value="Controller" {{ old('category', $produk->category) == 'Controller' ? 'selected' : '' }}>Controller</option>
                    <option value="VR" {{ old('category', $produk->category) == 'VR' ? 'selected' : '' }}>VR</option>
                </select>
            </div>
        </fieldset>
    ...
    <div class="wg-box">
        ...
        <div class="cols gap10">
            <button class="tf-button w-full" type="submit">Update Aksesoris</button>
        </div>
    </div>
</form>
