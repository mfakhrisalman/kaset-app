...
<div class="flex items-center flex-wrap justify-between gap20 mb-27">
    ...
    <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
        ...
        <li>
            <a href="#"><div class="text-tiny">Aksesoris</div></a>
        </li>
        <li>
            <i class="icon-chevron-right"></i>
        </li>
        <li>
            <div class="text-tiny">Data Daftar Aksesoris</div>
        </li>
    </ul>
</div>
<!-- order-list -->
<div class="wg-box">
    <div class="flex items-center justify-between gap10 flex-wrap">
        <a class="tf-button style-1 " href="/accessories/create"><i class="icon-plus"></i>Tambah aksesoris baru</a>
    </div>
    <table id="myTable" class="table table-striped table-hover " style="width:100%" >
        <thead class="">
            <tr class="table-title">
                <th class="body-title" style="text-align: left;">Game</th> <!-- Ganti header kolom -->
                <th class="body-title">Deskripsi</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="body-text">{{ $produk->description }}</td>
                ...
                <td style="text-align: right">
                    <div class="list-icon-function">
                        <a href="/accessories/{{ $produk->id }}/edit"><div class="item edit"><i class="icon-edit-3"></i></div></a>
                        <form action="/accessories/{{ $produk->id }}" method="post">
                            @method('delete')
                            @csrf
